        ...
        <div className="p-3 w-1/3 bg-slate-400">
            ...
            <div className="home px-5 pb-5">
                <div className="bg-red grid gap-6 mb-2">
                    <div>
                        <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Robot name (required)</label>
                    ...
                    <div>
                        <label htmlFor="robot_id" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Robot id (optional)</label>
                        <input type="text" id="robot_id" value={robotId} onChange={(e)=>setRobotId(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="robot 1" required />
                    </div>
                </div>
                <button onClick={() => {
                    // Ask the web server to register a new robot
                    var response = registerRobot(name, robotId)
                    if(response){
                        // Set success message
                        setStatus(true)
