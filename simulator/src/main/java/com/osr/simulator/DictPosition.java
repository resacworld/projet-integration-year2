...
public class DictPosition {
    private static final Map<Float,Position> positions = new HashMap<Float,Position>(){{
        ...
        put(4F, new Position("p_4","Stockage1_entry",null,true));
        put(5F, new Position("p_5","Stockage1_exit",null,true));
        put(6F, new Position("p_6","Pink",new Cube(PINK),false));
        put(7F, new Position("p_7","Blue",new Cube(BLUE),false));
        put(8F, new Position("p_8","Stockage2_entry",null,true));
        put(9F, new Position("p_9","Stockage2_exit",null,true));
        ...
        put(4.5F, new Position("p_4_5","Stockage1_middle",null,true));
        ...
        put(8.5F, new Position("p_8_9","Stockage2_middle",null,true));
